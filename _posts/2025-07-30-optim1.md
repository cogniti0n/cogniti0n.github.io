...
_I follow Ryu and Yin's notations[2]._
...
A function is proper if the function is never $-\infty$ and somewhere finite. A function is closed if the epigraph of $f$ is closed.

> **Definition** The _epigraph_ of $f$ is defined as
>
>$$
\mathrm{epi}\,f \equiv \{ (x,\alpha) \in \R^n \times \R \, | \, f(x) \le \alpha \}
>$$
