...
This is because total duality ensures the existence of a minimizer of $f+g$, and therefore a zero of $\partial f + \partial g$. Then we apply DRS for this problem, which generates the following FPI.
